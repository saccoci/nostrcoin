...
The smallest unit of NSTC is called a "nak" (1 NSTC = 100,000,000 naks), analogous to satoshis in Bitcoin.
...
- **Nak**: The smallest unit of NSTC (0.00000001 NSTC = 1 nak)
...
The smallest amount you can send is **1 nak** (0.00000001 NSTC) - like sending a penny, but way smaller.
...
- **Base Unit**: 1 nak = 0.00000001 NSTC
- **Precision**: 8 decimal places (100,000,000 naks per NSTC)
...
- Microtransaction capabilities (transfer any amount ≥ 1 nak)
...
The smallest unit, the nak, represents not just a fraction of NSTC but a symbol of Nostr's potential to host diverse decentralized systems beyond social networking.
...
- **Epoch**: 10-minute time window for mining competition
- **Indexer**: Node that validates and indexes Nostrcoin events
- **Nak**: Smallest unit (0.00000001 NSTC)
- **Nestacy/Nest**: Colloquial name for NSTC
- **NSTC**: Nostrcoin ticker symbol
- **Proof-of-Work**: Computational puzzle requiring 4 leading zeros

### Appendix C: Resources

- **Repository**: https://github.com/saccoci/nostrcoin
- **Forum**: https://nostrcoin.boards.net
- **Validator Library**: `nostrcoin-validator.js` (standalone)
...
**License**: MIT  
**Educational Use Only**: No monetary value