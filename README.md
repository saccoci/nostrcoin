...
**ALL Nostrcoin activity is permanently public and linked to your Nostr identity:**

- Every block you mine is publicly visible with your npub
- Every transaction you make or receive is publicly recorded
- Anyone can calculate your exact NSTC balance at any time
- Your complete transaction history is accessible forever
- If your npub is linked to your real identity, all NSTC activity is linked to you

**Privacy recommendations:**
- Use a separate "nym-only" Nostr account for NSTC
- Never link your NSTC npub to your real identity
- Assume all activity is as public as posting on social media
- Do not use NSTC for transactions you want to keep private

**This is a fundamental limitation of building on Nostr's public event system.**
